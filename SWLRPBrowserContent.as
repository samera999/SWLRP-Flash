...
class GUI.SWLRP.SWLRPBrowserContent extends com.Components.WindowComponentContent
{
   ...
   function configUI()
   {
      ...
      this.m_Browser = new com.GameInterface.Browser.Browser(2.0000, this.m_Loader._width, this.m_Loader._height); //Loads browser. The 5.000 is a browser ID state and I think it's unused from TSW.
	...
	else if (Character.GetCharacter(Char).GetID().IsPlayer())
	{
		...
		//this.m_Browser.OpenURL("https://swlrp.incertitu.de/check/123,345,567"); //Live
		}
    }
